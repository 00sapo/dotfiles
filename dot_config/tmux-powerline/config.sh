...
export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/home/federico/.mail/inbox/new"
...
export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/home/federico/.mailcheckrc"
# }
